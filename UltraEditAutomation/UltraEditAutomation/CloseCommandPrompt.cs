...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The CloseCommandPrompt recording.
    /// </summary>
    [TestModule("7ef26525-6370-4726-bb94-d4fed520d5f3", ModuleType.Recording, 1)]
    public partial class CloseCommandPrompt : ITestModule
    {
        /// <summary>
        ...
        static CloseCommandPrompt instance = new CloseCommandPrompt();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public CloseCommandPrompt()
        {
        }
        ...
        /// </summary>
        public static CloseCommandPrompt Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Host.Current.CloseApplication(repo.AdministratorCmd.Self, new Duration(0));
            Delay.Milliseconds(0);
